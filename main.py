...
if __name__ == '__main__':
    ...
    post = 7
    data_type = 'dff'
    dataset = prep_dataset(boc, exps[19:20], pre, post, data_type=data_type)
    if data_type == 'dff':
    ...
    batch_size = 128
    clip = 1
    # model, train_loss, train_error, val_error, val_loss = trainRNN(model, criterion, optimizer, scheduler, epochs, batch_size, clip, train_dataset, test_dataset, dry_run=True)
